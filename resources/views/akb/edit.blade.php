    ...
    <section class="bg-white py-4 rounded-lg mb-4 antialiased md:py-8">
        <div class="mx-auto max-w-screen-xl px-4 2xl:px-0">
            <div class="mx-auto max-w-5xl">
                <form action="{{ route('akb.update', $AKB->id_data_akb) }}" method="POST">
                    @csrf
                    @method('PUT')
                    <div class="mb-4">
                        <label for="id_tahun" class="block text-sm font-medium text-gray-700">Tahun</label>
                        <input type="text" id="id_tahun" name="id_tahun" value="{{ $AKB->tahun->tahun }}"
                    ...
                    <div class="mb-4">
                        ...
                        <input type="text" id="id_puskesmas" name="id_puskesmas"
                            value="{{ $AKB->puskesmas->nama_puskesmas }}"
                            class="block w-full mt-1 border-gray-300 rounded-md shadow-sm focus:ring-red-500 focus:border-red-500"
                            readonly>
                    </div>
                    <div class="mb-4">
                        ...
                        <input type="text" id="id_kecamatan" name="id_kecamatan"
                            value="{{ $AKB->kecamatan->nama_kecamatan }}"
                            class="block w-full mt-1 border-gray-300 rounded-md shadow-sm focus:ring-red-500 focus:border-red-500"
                            readonly>
                    </div>
                    <div class="mb-4">
                        <label for="akb" class="block text-sm font-medium text-gray-700">Jumlah AKB</label>
                        <input type="number" id="akb" name="akb" value="{{ old('akb', $AKB->akb) }}"
                            class="block w-full mt-1 border-gray-300 rounded-md shadow-sm focus:ring-red-500 focus:border-red-500">
                        @error('akb')
