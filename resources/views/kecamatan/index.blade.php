...
@section('content')
    ...
    <div class="mt-4">
        <form method="GET" action="{{ route('kecamatan.index') }}">
            <div class="flex justify-end items-center mx-28">
                <input type="text" name="search" class="w-1/4 p-2 border border-gray-300 rounded-lg mx-4"
                    placeholder="Cari Kecamatan..." value="{{ request('search') }}">
                <button type="submit" class="ml-2 bg-red-500 text-white p-2 rounded-lg hover:bg-red-500">
                    Cari
                </button>
            </div>
        </form>
