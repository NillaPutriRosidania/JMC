        ...
        <ul class="space-y-2">
            <li>
                <a href="{{ route('dashboard.index') }}"
                    class="@if (Route::is('dashboard.index')) bg-white text-red-500 @else text-white @endif flex items-center p-2 text-base font-medium rounded-lg hover:bg-white hover:text-red-500">
                    <svg aria-hidden="true"
                        class="@if (Route::is('dashboard.index')) text-red-500 @else text-white @endif w-6 h-6 transition duration-75 group-hover:text-red-500"
                ...
                <ul id="dropdown-pages" class="hidden py-2 space-y-2">
                    <li>
                        <a href="{{ route('kecamatan.index') }}"
                            class="@if (Route::is('kecamatan.index')) bg-white text-red-500 @else text-white @endif flex items-center p-2 pl-11 w-full text-base font-medium rounded-lg transition duration-75 group hover:bg-white hover:text-red-500">
                            Kecamatan
                        </a>
                    </li>
                </ul>
